...
export default function PaymentSuccess() {
  ...
  const { orderId, paymentMethod, bookingDate, bookingTime, total } =
    location.state || {};
        ...
        <div className="row justify-content-center">
          <div className="col-md-6">
            ...
            >
              ...
              <p className="mb-2">
                <strong>Order ID:</strong> {orderId || "Will be shown here"}
              </p>
              <p className="mb-2">
                <strong>Payment Method:</strong> {paymentMethod || "ONLINE"}
              </p>
              <p className="mb-2">
